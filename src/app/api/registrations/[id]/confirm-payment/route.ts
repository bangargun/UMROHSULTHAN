    ...
    if (!pilgrim) {
      ...
      pilgrim = await prisma.pilgrim.create({
        data: {
          ...
          vaccineNumber: reg.vaccineNumber || null,
          vaccineType: reg.vaccineType || (reg.vaccineNumber ? "MENINGITIS" : null),
          vaccineClinicName: reg.vaccineClinicName || null,
          vaccineDate: reg.vaccineDate || null,
          vaccineExpiryDate: reg.vaccineExpiryDate || null,
          vaccineStatus: reg.vaccineNumber ? "VACCINATED" : "NOT_VACCINATED",
