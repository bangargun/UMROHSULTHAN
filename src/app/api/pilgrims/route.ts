  ...
  try {
    ...
    const pilgrim = await prisma.pilgrim.create({
      data: {
        ...
        passportIssuedCity: passportIssuedCity || null,
        ...
        job: job || null,
        visaProvider: visaProvider || null,
        ...
        hasMeningitisVaccine: Boolean(hasMeningitisVaccine || meningitisVaccineNumber),
        meningitisVaccineNumber: meningitisVaccineNumber || null,
        meningitisVaccineClinic: meningitisVaccineClinic || null,
        meningitisVaccineDate: meningitisVaccineDate ? new Date(meningitisVaccineDate) : null,
        meningitisVaccineExpiry: meningitisVaccineExpiry ? new Date(meningitisVaccineExpiry) : null,
        hasPolioVaccine: Boolean(hasPolioVaccine || polioVaccineNumber),
        polioVaccineNumber: polioVaccineNumber || null,
        polioVaccineClinic: polioVaccineClinic || null,
        polioVaccineDate: polioVaccineDate ? new Date(polioVaccineDate) : null,
        polioVaccineExpiry: polioVaccineExpiry ? new Date(polioVaccineExpiry) : null,
        vaccineNumber: meningitisVaccineNumber || vaccineNumber || null,
        vaccineType: vaccineType || (meningitisVaccineNumber ? "MENINGITIS" : (polioVaccineNumber ? "POLIO" : null)),
        vaccineClinicName: meningitisVaccineClinic || vaccineClinicName || null,
        vaccineDate: meningitisVaccineDate ? new Date(meningitisVaccineDate) : (vaccineDate ? new Date(vaccineDate) : null),
        vaccineExpiryDate: meningitisVaccineExpiry ? new Date(meningitisVaccineExpiry) : (vaccineExpiryDate ? new Date(vaccineExpiryDate) : null),
        vaccineStatus: (hasMeningitisVaccine || hasPolioVaccine || vaccineNumber) ? "VACCINATED" : "NOT_VACCINATED",
