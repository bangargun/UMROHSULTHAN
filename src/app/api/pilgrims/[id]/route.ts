  ...
  try {
    ...
    const updated = await prisma.pilgrim.update({
      ...
      data: {
        ...
        hasMeningitisVaccine: hasMeningitisVaccine !== undefined ? Boolean(hasMeningitisVaccine) : undefined,
        meningitisVaccineNumber: meningitisVaccineNumber !== undefined ? meningitisVaccineNumber : undefined,
        meningitisVaccineClinic: meningitisVaccineClinic !== undefined ? meningitisVaccineClinic : undefined,
        meningitisVaccineDate: parseDateSafe(meningitisVaccineDate),
        meningitisVaccineExpiry: parseDateSafe(meningitisVaccineExpiry),
        hasPolioVaccine: hasPolioVaccine !== undefined ? Boolean(hasPolioVaccine) : undefined,
        polioVaccineNumber: polioVaccineNumber !== undefined ? polioVaccineNumber : undefined,
        polioVaccineClinic: polioVaccineClinic !== undefined ? polioVaccineClinic : undefined,
        polioVaccineDate: parseDateSafe(polioVaccineDate),
        polioVaccineExpiry: parseDateSafe(polioVaccineExpiry),
        vaccineNumber: meningitisVaccineNumber !== undefined ? (meningitisVaccineNumber || null) : (vaccineNumber !== undefined ? vaccineNumber : undefined),
        vaccineType: vaccineType !== undefined ? vaccineType : (meningitisVaccineNumber ? "MENINGITIS" : undefined),
        vaccineClinicName: meningitisVaccineClinic !== undefined ? meningitisVaccineClinic : (vaccineClinicName !== undefined ? vaccineClinicName : undefined),
        vaccineDate: meningitisVaccineDate !== undefined ? parseDateSafe(meningitisVaccineDate) : (vaccineDate !== undefined ? parseDateSafe(vaccineDate) : undefined),
        vaccineExpiryDate: meningitisVaccineExpiry !== undefined ? parseDateSafe(meningitisVaccineExpiry) : (vaccineExpiryDate !== undefined ? parseDateSafe(vaccineExpiryDate) : undefined),
        vaccineStatus: vaccineStatus !== undefined ? vaccineStatus : undefined,
